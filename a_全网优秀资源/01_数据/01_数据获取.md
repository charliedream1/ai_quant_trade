...
- mootdx
  - 通达信数据读取的一个简便使用封装
  - Github (1.2k stars): https://github.com/mootdx/mootdx
  - 文档：https://mootdx-backup.github.io/
  - 已经不太维护
...
- Github (1.8k stars): https://github.com/zhangxiangliang/stock-api
- 网页：zhangxiangliang.github.io/stock-api/
