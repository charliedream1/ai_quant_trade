...
| **时间**     | **特性**                                                                                                                            |   
|:-----------|:----------------------------------------------------------------------------------------------------------------------------------|
| 2025.01.03 | [**大模型金融市场分析（视频教程见星球或公众号）**](egs_fin_nlp/a01_hot_topic_report/v1_proto_internet) |
...
- 陆续记录使用方法，方便使用：我们不做大而全的使用教程，那会让你迷失，我们至列举最常用且实用的功能，让你快速上手
...
| **序号**    | **工具**                                               |  
|:-------- |:-----------------------------------------------------|
| 1 | [**大模型金融市场分析（视频教程见星球或公众号）**](egs_fin_nlp/a01_hot_topic_report/v1_proto_internet) |
